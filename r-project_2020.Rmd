...
> Le premier téléchargement a échoué à la toute fin après de nombreuses heures mais nous avons rééssayé enb passant cette fois ci par un *curl* et nous avons enfin eu les données.
...
```{r}
posts <- read.csv('datasets/Posts3.csv')
# get only questions posts 
questions <- subset(posts, PostTypeId == "1")
